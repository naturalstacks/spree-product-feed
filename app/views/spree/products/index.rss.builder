...
xml.rss(:version=>"2.0", "xmlns:g" => "http://base.google.com/ns/1.0"){
  xml.channel{
    xml.title("Natural Stacks")
    xml.link("http://naturalstacks.com")
    xml.description("Find out about new products on http://naturalstacks.com]} first!")
    xml.language('en-us')
    @products.each do |product|
      xml.item do
        ...
        xml.author("http://naturalstacks.com")
